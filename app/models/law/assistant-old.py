...
intro= """
آءُ سنڌي قانوني مشير آهيان جيڪو آن لائين جديد مصنوعي ذهانت جي بڻياد تي ٺھيل ھڪ چيٽ بوٽ آهي، آءَ بنيادي قانوني معلومات سنڌي ٻوليءَ ۾ مھيا ڪرڻ لاءِ تيار ڪيو ويو آھي
...
"""
API_KEY = "b9e69259624f5c53541903c4e4bf7c54cb6bd552c44b32c4b611e9c67ce75348"
...
class SmartEmbedding:
    ...
    def __init__(self):
        self.model = None
        self.cache = {}
        self.cache_file = Path("legal_embeddings.pkl")
        self._load_model()
        self._load_cache()
...
**قانوني تفصيل** - لاڳاپيل قانوني دفعات
**عملي مشورو** - ڇا ڪرڻ گهرجي
**اهم نوٽ** - ضروري احتياط
**صحيح حوالا** - آرٽيڪل/سيڪشن نمبر
