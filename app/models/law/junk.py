...
ھدايتون:
1. تون پاڪستاني قانون جو ماهر آہین۔ ڏنل معلومات جي بنیاد تي درست جواب ڏي۔
...
def stream_llm_response(query: str, context: str, client):
    """
    Generator that streams LLM response tokens for a given query and context.
    """
    try:
        ...
        for chunk in response:
            # Robustly check for choices and delta.content
